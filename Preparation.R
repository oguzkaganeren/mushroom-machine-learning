...
#--------------------
#doðal deðerlerini buluyoruz proportion kýsmýnda lazým olacak
...
#dönen deðer ne kadar büyükse sýnýflandýrma için o kadar önemlidir.
#columns target dýþýnda yer alan diðer attributeslarý alýr
#parametre olarak verilen centroid deðeri dogal posion deðeridir
...
print(proportions_tab)
#neden iki tanesini çýkardýk(norm err. 0.5 altýnda kalýyor ikisinde de ondan dolayý)
#stalk_shape ve veil_type en düþük deðere sahip(iki target içinde)
